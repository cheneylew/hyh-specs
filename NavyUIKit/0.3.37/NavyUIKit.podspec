...
NavyUIKit 一组常用快速开发的UI框架。
  ...
  s.source           = { :git => 'http://git.love-program.com/group/NavyKit.git', :tag => s.version.to_s }
  ...
  s.ios.deployment_target = '8.0'
    ...
    s.subspec '3rds_TYWaveProgressView' do |sp|
    sp.requires_arc        = true
    sp.source_files = 'NavyUIKit/Classes/3rds/TYWaveProgressView/*.{h,m}'
    end
    ...
    sp.requires_arc        = true
    sp.source_files = 'NavyUIKit/Classes/NavyKit/NavyUIKit/*','NavyUIKit/Classes/NavyKit/NavyUIKit/Classes/Categories/**/*','NavyUIKit/Classes/NavyKit/NavyUIKit/Classes/Deploy/**/*','NavyUIKit/Classes/NavyKit/NavyUIKit/Classes/Glass/**/*','NavyUIKit/Classes/NavyKit/NavyUIKit/Classes/H5Comunicator/**/*','NavyUIKit/Classes/NavyKit/NavyUIKit/Classes/MVVM/**/*','NavyUIKit/Classes/NavyKit/NavyUIKit/Classes/WebBrowser/**/*','NavyUIKit/Classes/NavyKit/NavyUIKit/Classes/TableView/**/*','NavyUIKit/Classes/NavyKit/NavyUIKit/Classes/Abstract/**/*','NavyUIKit/Classes/NavyKit/NavyUIKit/Classes/JControls/**/*'
    sp.dependency 'NavyUIKit/Categories'
    sp.dependency 'NavyUIKit/NavyCoreFundation'
    sp.dependency 'NavyUIKit/3rds_KC_encryption'
    sp.dependency 'NavyUIKit/3rds_TYWaveProgressView'
    sp.dependency 'NavyUIKit/3rds_DBImageView'
        ...
        sp.subspec 'Abstract' do |spsp|
        spsp.requires_arc        = true
        spsp.source_files = 'NavyUIKit/Classes/NavyKit/NavyUIKit/Classes/Abstract/**/*'
        spsp.dependency 'NavyUIKit/NavyCoreUIKit/Macros'
        end
        sp.subspec 'JControls' do |spsp|
        spsp.requires_arc        = true
        spsp.source_files = 'NavyUIKit/Classes/NavyKit/NavyUIKit/Classes/JControls/**/*'
        spsp.dependency 'NavyUIKit/NavyCoreUIKit/Abstract'
        end
